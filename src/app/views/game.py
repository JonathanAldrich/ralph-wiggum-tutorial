...
Serves the Pong game homepage. The game itself is a pure client-side
TypeScript engine mounted as a React Island; the backend only needs to
render the HTML shell that contains the island mount point.
...
def index():  # type: ignore[no-untyped-def]
    ...
    frontend hydrates with the canvas-based Pong game on the client.
    """
