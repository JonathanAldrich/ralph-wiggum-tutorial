 ...
 * found in the DOM. The Pong game needs no server-provided props (it is
 * entirely client-side), so `props` is ignored; the signature is kept uniform
 * with the island contract so the registry can treat all islands identically.
 */
